...
SkyBox::SkyBox(vkw::Device &device, vkw::RenderPass const &pass, uint32_t subpass) :
        ...
        m_lighting_layout(device, RenderEngine::LightingLayout::CreateInfo{.substageDescription=RenderEngine::SubstageDescription{.shaderSubstageName="skybox"}, .pass=pass, .subpass=subpass}, 1),
