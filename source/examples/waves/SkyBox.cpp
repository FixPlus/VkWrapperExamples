...
SkyBox::SkyBox(vkw::Device &device, vkw::RenderPass const &pass, uint32_t subpass) :
        ...
        m_material_layout(device, RenderEngine::MaterialLayout::CreateInfo{.substageDescription=RenderEngine::SubstageDescription{.shaderSubstageName="skybox",.setBindings={{0, VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER}, {1, VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER}}},.maxMaterials=1}),
