...
#ifdef _WIN32
  auto surface = vkw::Surface(instance, GetModuleHandle(NULL),
                              glfwGetWin32Window(m_window));
#elif defined(__linux__)
  auto surface =
      vkw::Surface(instance, glfwGetX11Display(), glfwGetX11Window(m_window));
#else
...
vkw::Instance Window::vulkanInstance(vkw::Library &vulkanLib,
...
#ifdef __linux__
  createInfo.requestExtension(
      vkw::Library::ExtensionId(VK_KHR_XLIB_SURFACE_EXTENSION_NAME));
#endif
...
void Window::initImpl() { static GlfwLibKeeper glfwKeeper{}; }
